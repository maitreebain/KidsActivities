...
//     }
     ...
     private func setUpImageView() {
         ...
         NSLayoutConstraint.activate([
             letterImageView.topAnchor.constraint(equalTo: lettCollectionView.bottomAnchor, constant: 40),
     ...
     private func setUpTextBox() {
         ...
         NSLayoutConstraint.activate([
             letterTextView.topAnchor.constraint(equalTo: letterImageView.bottomAnchor, constant: 40),
     ...
     private func setUpSubmitButton() {
         ...
         NSLayoutConstraint.activate([
             submitButton.topAnchor.constraint(equalTo: letterTextView.bottomAnchor, constant: 30),
